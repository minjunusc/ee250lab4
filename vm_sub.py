...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("minjun/ipinfo")
    client.subscribe("minjun/dateinfo")
    client.subscribe("minjun/timeinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("minjun/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("minjun/dateinfo", on_message_from_dateinfo)
    client.message_callback_add("minjun/timeinfo", on_message_from_timeinfo)
